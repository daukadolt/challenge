...
class BamlAsyncClient:
    ...
    async def ExtractControl(self, control: str,
        baml_options: BamlCallOptions = {},
    ) -> types.Control:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.ExtractControl(control=control,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractControl", args={
                "control": control,
            })
            return typing.cast(types.Control, result.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ExtractControl(self, control: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Control, types.Control]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractControl", args={
            "control": control,
        })
        return baml_py.BamlStream[stream_types.Control, types.Control](
          result,
          lambda x: typing.cast(stream_types.Control, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.Control, x.cast_to(types, types, stream_types, False, __runtime__)),
          ctx,
        )
...
class BamlHttpRequestClient:
    ...
    async def ExtractControl(self, control: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractControl", args={
            "control": control,
        }, mode="request")
        return result
    async def ExtractResume(self, resume: str,
